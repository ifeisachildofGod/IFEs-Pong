...
from src.logic.game import ColorType
from src.ui.ui_constants import *
from src.game.game_constants import *
from src.game.game_components import Ball, Player
from src.ui.ui_components import Button, Input, Selector, InputSeletor, ClickableText
...
class GameApp:
    ...
    def _init_pause_vars(self):
        ...
        self.pause_bg_img = pygame.transform.scale(pygame.image.load(r'src\ui\Untitled.png'), (self.SCR_WIDTH, self.SCR_HEIGHT))
        ...
        if self.multiplayer_scr or self.multiplayer_scr_bt or self.multiplayer_scr_serv:
            ...
            if self.started:
                if self.changed_ctrl_state:
                    ...
                    self.p1_control = 'AI'
                    self.changed_ctrl_state = False
        # self.setting_texts = {name: mods.font_renderer(name, FONT3, self.BG_COLOR if index == self.setting_focus else self.FG_COLOR) for index, name in enumerate(self.settings_optinons)}
        self.setting_texts = {
