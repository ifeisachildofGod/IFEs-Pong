...
class Player:
    ...
    def _keys(self, up, down):
        ...
        self._move(keys[down], keys[up], True)
    ...
    def update(self, control: str, ball_things: list[pygame.Rect, int], left: bool, mouse, speed, up: int, down: int, ai_difficulty: str, col=fg_color, skin = None):
        self.player_input(control, ball_things, left, ai_difficulty, up, down, mouse)
        self.movement(speed)
        self.draw(col, skin)
