...
class GameApp:
    ...
    def _init_some_very_important_buttons(self):
        ...
        self.saa_button = Button(self.screen, self.FG_COLOR, (self.SCR_WIDTH - self.saa_size[0] - 50, self.SCR_HEIGHT - self.saa_size[1] - 30), self.saa_size, txt='Save and Apply', txt_color=self.BG_COLOR, sound_info=self.button_sound_info)
    ...
    def settings(self, multiplayer=False):
        self.settings_disabled = self.saa_button.disabled = self.ptb_up_input.mini_win.isactive() or self.ptb_down_input.mini_win.isactive() or self.pob_up_input.mini_win.isactive() or self.pob_down_input.mini_win.isactive()
        ...
        if multiplayer:
            ...
            self.saa_button.activate_button(mouse_rect=self.mouse_rect, mouse_clicked=self.mouse_clicked, on_click=self._mult_save_and_apply, color=(self.FG_COLOR, self.BG_COLOR), text="   Continue  ")
        else:
            ...
            self.saa_button.activate_button(mouse_rect=self.mouse_rect, mouse_clicked=self.mouse_clicked, on_click=self._save_and_apply_settings, color=(self.FG_COLOR, self.BG_COLOR), text='Save and apply')
    ...
    def update(self):
        ...
        self.setting_texts = {
            ...
            SETTINGS_DICT_BG_OPT_KEY: mods.font_renderer(self.bg_txt_view_input, FONT3, self.tv_bg_color),
            SETTINGS_DICT_FG_OPT_KEY: mods.font_renderer(self.fg_txt_view_input, FONT3, self.tv_fg_color),
        ...
        self.setting_text_rects = {
            ...
            SETTINGS_DICT_BG_OPT_KEY: mods.font_rect_renderer(self.screen, self.bg_txt_view_input, FONT3.render(self.bg_txt_view_input, False, self.FG_COLOR), y=SETTINGS_TEXT_START_POS, x_offset= X_SETTINGS_TEXT_OFFSET),
            SETTINGS_DICT_FG_OPT_KEY: mods.font_rect_renderer(self.screen, self.fg_txt_view_input, FONT3.render(self.fg_txt_view_input, False, self.FG_COLOR), y=SETTINGS_TEXT_START_POS + SETTINGS_TEXT_SPACING, x_offset= X_SETTINGS_TEXT_OFFSET),
